...
import type { PaymentsService, DepositOptions } from "@filoz/synapse-sdk/payments";
import { ethers } from "ethers";
...
**API Reference**: [PDPAuthHelper API Reference](/reference/filoz/synapse-sdk/pdp/classes/pdpauthhelper/)
...
**API Reference**: [PDPServer API Reference](/reference/filoz/synapse-sdk/pdp/classes/pdpserver/)
...
const dataSetId = null as unknown as number;
const pieceDataArray = null as unknown as PieceCID[] | string[];
const data = null as unknown as Uint8Array | AsyncIterable<Uint8Array> | ReadableStream<Uint8Array>;
